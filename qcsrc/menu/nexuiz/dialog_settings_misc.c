...
void fillNexuizMiscSettingsTab(entity me)
{
	...
	me.TR(me);
		...
		me.TD(me, 1, 1, e = makeNexuizSliderCheckBox(-1000000, 1, s, _("Game:")));
		me.TD(me, 1, 2, s);
	me.TR(me);
		s = makeNexuizDecibelsSlider(-20, 0, 0.5, "snd_staticvolume");
		me.TD(me, 1, 1, e = makeNexuizSliderCheckBox(-1000000, 1, s, _("Ambient:")));
		me.TD(me, 1, 2, s);
	me.TR(me);
	me.TR(me);
	...
	me.gotoRC(me, 0, 3.5); me.setFirstColumn(me, me.currentColumn);
		me.TD(me, 1, 3, e = makeNexuizCheckBox(0, "cl_autodemo", _("Demo recording")));
	me.TR(me);
	me.TR(me);
	...
	me.TR(me);
		me.TD(me, 1, 3, e = makeNexuizTextLabel(0, _("Speedmeter:")));
	me.TR(me);
		me.TDempty(me, 0.2);
		me.TD(me, 1, 2.8/3, e = makeNexuizRadioButton(1, "showspeed", "0", _("Off")));
	...
	me.gotoRC(me, me.rows - 1, 0);
		me.TD(me, 1, me.columns, makeNexuizCommandButton(_("Apply immediately"), '0 0 0', "snd_restart", COMMANDBUTTON_APPLY));
}
#endif
