...
void loadMapInfoNexuizMapInfoDialog(entity me, float i)
{
	...
	me.titleBar.setText(me.titleBar, me.currentMapBSPName);
...
void fillNexuizMapInfoDialog(entity me)
{
	...
	me.TR(me);
		me.TD(me, 1, w, e = makeNexuizTextLabel(0, ""));
			...
			me.featuresLabel = e;
	me.TR(me);
		me.TD(me, 1, w, e = makeNexuizTextLabel(0, _("Game types:")));
	me.TR(me);
		me.TD(me, 1, w/4, e = makeNexuizTextLabel(0, _("Deathmatch")));
			me.typeDeathmatchLabel = e;
		me.TD(me, 1, w/4, e = makeNexuizTextLabel(0, _("TDM")));
			me.typeTDMLabel = e;
		me.TD(me, 1, w/4, e = makeNexuizTextLabel(0, _("LMS")));
			me.typeLMSLabel = e;
		me.TD(me, 1, w/4, e = makeNexuizTextLabel(0, _("Arena")));
			me.typeArenaLabel = e;
	me.TR(me);
		me.TD(me, 1, w/4, e = makeNexuizTextLabel(0, _("Rune")));
			me.typeRuneLabel = e;
		me.TD(me, 1, w/4, e = makeNexuizTextLabel(0, _("Domination")));
			me.typeDominationLabel = e;
		me.TD(me, 1, w/4, e = makeNexuizTextLabel(0, _("Key Hunt")));
			me.typeKeyHuntLabel = e;
		me.TD(me, 1, w/4, e = makeNexuizTextLabel(0, _("CTF")));
			me.typeCTFLabel = e;
	me.TR(me);
		if(cvar("developer"))
		{
			me.TD(me, 1, w/4, e = makeNexuizTextLabel(0, _("Assault")));
				me.typeAssaultLabel = e;
			me.TD(me, 1, w/4, e = makeNexuizTextLabel(0, _("Onslaught")));
